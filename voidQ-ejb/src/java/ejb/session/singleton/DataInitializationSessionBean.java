    ...
    private void initializeData() {
        try {
            ...
            partnerSessionBeanLocal.retrievePartnerByPartnerId(5L).getDoctorEntities().add((DoctorEntity) partnerSessionBeanLocal.createNewStaff(new DoctorEntity("Doctor5B@gmail.com", "password", "Minli", "Tan", partnerSessionBeanLocal.retrievePartnerByPartnerId(5L), Availability.AVAILABLE)));
              partnerSessionBeanLocal.retrievePartnerByPartnerId(5L).getDoctorEntities().add((DoctorEntity) partnerSessionBeanLocal.createNewStaff(new DoctorEntity("Doctor6A@gmail.com", "password", "KaiNing", "Shi", partnerSessionBeanLocal.retrievePartnerByPartnerId(5L), Availability.AVAILABLE)));
            partnerSessionBeanLocal.retrievePartnerByPartnerId(5L).getDoctorEntities().add((DoctorEntity) partnerSessionBeanLocal.createNewStaff(new DoctorEntity("Doctor6B@gmail.com", "password", "JunHao", "Toh", partnerSessionBeanLocal.retrievePartnerByPartnerId(5L), Availability.AVAILABLE)));
